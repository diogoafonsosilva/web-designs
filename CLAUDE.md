...
- 2026-08-09 — Projeto "Fiat Flow Tracker" adicionado (index.html + projects.html). Usa thumb `.project-logo-thumb` com ícone SVG inline (sem asset de imagem). Link aponta para `https://fiat-flow-demo.vercel.app` (deploy público dedicado, dataset fictício — repo fonte continua privado).
